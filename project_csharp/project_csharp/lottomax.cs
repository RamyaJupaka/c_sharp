...
namespace project_csharp
{
    public partial class lottomax : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Random random = new Random(unchecked((int)DateTime.Now.Ticks)); //create an object of the Random
            ...
            for (int i = 0; i < 7; i++)          // get the the number random and then stored to an array.
            {
            ...
            DateTime currentdate = DateTime.Now;  //create an object of the date
            ...
            int indexspace = g.LastIndexOf(" ");   //loading for the index of lastspace
            ...
            try
            {
                ...
                streamWriter.Write("LotoMax" + " " + g + " " + date + " " + time + "\n");
                streamWriter.Close();
            }
            catch (FileNotFoundException) //catch error
            {
        ...
        public int getNum(int[] arrnum, int tmp, Random random)
        {
            ...
            int n = 0;
            while (n <= arrnum.Length - 1)      //the function use the approach of Recursion to reduce odds getting same number
            {
                if (arrnum[n] == tmp)
                {
                    tmp = random.Next(1, 49);
        ...
        {
            int i = 0;                                  // exit the button to ask the user exit or no
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while ((line = sr.ReadLine()) != null)  //read the file until the null
                {
